...
class BaseService {
  ...
  public async delete<T>(uri: string): Promise<Response> {
...
class InventoryService {
  ...
  public async deleteItem(id: string): Promise<Response> {
    return await baseService.delete(`${API_CONFIG.ENDPOINTS.INVENTORY}/${id}`)
  }
}
...
class EmployeeService {
  ...
  public async deleteEmployee(employeeId: string) {
    return await baseService.delete<Employee>(`${API_CONFIG.ENDPOINTS.EMPLOYEES}/${employeeId}`);
  }
...
class AssemblyService {
  ...
  public async deleteAssembly(id: string): Promise<Response> {
    return await baseService.delete(`${API_CONFIG.ENDPOINTS.ASSEMBLY}/${id}`);
  }
...
class ProjectService {
  ...
  public async deleteProject(projectId: string) {
    return await baseService.delete<Employee>(`${API_CONFIG.ENDPOINTS.PROJECTS}/${projectId}`);
  }
}
...
class ProductService {
  ...
  public async deleteProduct(id: string): Promise<Response> {
    return await baseService.delete(`${API_CONFIG.ENDPOINTS.PRODUCTS}/${id}`);
  }
}
...
class LogService {
  ...
  public async deletryRegistry(id: string): Promise<Response> {
    return await baseService.delete(`${API_CONFIG.ENDPOINTS.LOGS}/${id}`);
  }
}
